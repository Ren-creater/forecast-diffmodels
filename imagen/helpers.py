...
sys.path.append("$HOME/researchProject/forecast-diffmodels/dataproc")
from utils import *
...
def get_satellite_data(args):
    ...
    test_set = pickle.load(open("$HOME/researchProject/forecast-diffmodels/dataproc/test_set.pkl", "rb"))
