...
BASE_DIR = f"/vol/bitbucket/zr523/models/{RUN_NAME}/models/64_PRP_woERA5/"
...
args.dataset_path = f"/vol/bitbucket/zr523/research_project/satellite/dataloader/{args.o_size}_PRP"
...
with open(f"/vol/bitbucket/zr523/models/{RUN_NAME}/metrics.pkl", "wb") as file:
